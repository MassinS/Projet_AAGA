...
csv_path = os.path.join(result_dir, "resume.csv")
...
bar_path = os.path.join(result_dir, "bar.png")
...
scatter_path = os.path.join(result_dir, "scatter_logscale.png")
...
speedup_path = os.path.join(result_dir, "speedup.png")
